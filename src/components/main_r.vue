<template>
  <div class="main">
    <div class="logo">
      ...
      <div class="titles">
        <p class="cn">{{city.cityname}}</p>
        <p class="en">{{city.id}}</p>
      </div>
      <div class="like wrap">
        <span class="icon">
      ...
      <div class="arrived wrap">
        <span class="icon">
          <van-icon name="flag-o" size="25px" />
        </span>
    ...
    <div class="recommend-about">
      ...
      <div class="rd-sec-wrap">
        <div class="rd-left">
          <a class="rd-section" href="#" v-for="item in tree" :key="item.id">
            <div class="rd-cover">
              <img class="rd-cover-img" src="../assets/img/file1.gif" />
            </div>
            <div class="rd-description">情人节特辑 | 旅行超燃混剪，我们闪闪发光的2018 北京 美国 日本 巴厘岛</div>
            <div class="rd-message">
              <div class="rd-author">
                <img src="../assets/img/file1.jpg" />
                <span>二砚与马桶</span>
              </div>
              <div class="rd-like">
                <img src="//fes.qyerstatic.com/Fj-VcWESzlI9yWVjHLGTIgxSyyiq" />
                <span>649</span>
              </div>
            </div>
          </a>
        ...
        <div class="rd-right">
          <a class="rd-section" href="#" v-for="item in tree" :key="item.id">
            ...
            <div class="rd-description">Hello穷游的小伙伴们大家好，我是演员王智！ 很开心可以加入穷游这个大家庭，我</div>
            <div class="rd-message">
              <div class="rd-author">
                <img src="../assets/img/file2.jpg" />
                <span>演员王智</span>
              </div>
              <div class="rd-like">
                <img src="//fes.qyerstatic.com/Fj-VcWESzlI9yWVjHLGTIgxSyyiq" />
      ...
      <div class="rd-down-btn rd-sec-wrap">
        <a href="#">
        ...
        <ul>
          <li v-for="(item,index) in tours" :key="item.id">
            <a href="#" class="qui-place-link">
              <div class="poi-img" style="height: 104px;">
                <img :src="require('../assets/img/liang' + (index+1) + '.jpg')" />
              </div>
              <div class="poi-info">
...
export default {
  ...
  mounted() {
    this.city.cityname = this.$route.params.cityname
      ? this.$route.params.cityname
      : "东京";
    this.city.id = this.$route.params.id ? this.$route.params.id : "Tokyo";
  }
};
</script>
